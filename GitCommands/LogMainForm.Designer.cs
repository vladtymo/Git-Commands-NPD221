namespace GitCommands
{
    partial class LogMainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Sitka Display", 10.8F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 204);
            label1.ForeColor = SystemColors.WindowText;
            label1.Location = new Point(29, 31);
            label1.Name = "label1";
            label1.Size = new Size(1300, 598);
            label1.TabIndex = 0;
